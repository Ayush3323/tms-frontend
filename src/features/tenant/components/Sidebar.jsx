...
const Sidebar = () => {
  const menuItems = [
    { name: 'Users', icon: <LayoutGrid size={18} />, path: '/tenant/dashboard/users' },
    { name: 'Vehicles', icon: <Users size={18} />, path: '/tenant/dashboard/vehicles' },
    { name: 'Drivers', icon: <Globe size={18} />, path: '/tenant/dashboard/drivers' },
  ];
